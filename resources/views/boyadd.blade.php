                            ...
                            <form method="POST" action="{{route('young') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control {{$errors->has('language') ? 'is-invalid' :''}}" name="language" value="{{ old('language') }}">
                                        <!-- <option value="{{isset($post) ? $post->language : '' }}" selected>{{isset($post) ? $post->language : '質問したい言語'}}</option> -->
                    ...
                    @else
                        <div class="card-body p-5" >
                            <div class="text-center">
                                ...
                                <div class="pt-1 pb-3"><a href="{{route('register')}}" class="btn btn-default border border-primary" style="border-radius:50px; width:35%;">初めての方（会員登録）</a></div>
