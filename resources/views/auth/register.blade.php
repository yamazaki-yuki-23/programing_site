                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row">
                                <label for="email" class="col-4 col-form-label text-md-right">メールアドレス</label>
                                <div class="col-6">
                            ...
                            <div class="form-group row">
                                <label for="password-confirm" class="col-4 col-form-label text-md-right">確認用パスワード</label>
                                <div class="col-6">
